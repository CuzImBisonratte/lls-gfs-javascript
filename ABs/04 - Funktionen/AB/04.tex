...
\awesomebox{5pt}{\faTasks}{orange}{
	\textbf{a)} Erstelle in 04a.html eine Funktion, die den Text in einem \texttt{<p>}-Element ändert.
}
...
function addiere(a, b) {
	document.getElementById("ergebnis").innerHTML = a + b;
}
...
\awesomebox{5pt}{\faTasks}{orange}{
	\textbf{b)} Erstelle eine Funktion, die zwei Zahlen \textbf{multipliziert} und das Ergebnis in einem \texttt{<p>}-Element ausgibt.
}
...
\awesomebox{5pt}{\faTasks}{orange}{
	\textbf{c)} Gib in 04c.html den beiden Knöpfen verschiedene Funktionen, die jeweils verschiedene Zahlen addieren und multiplizieren.
}
